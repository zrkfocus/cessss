(function (win) {
    ...
    function createRank(style, imgSetting, rankDataList) {
        var rankStyle = `  .rank_container {
            ...
            .goto_shop {
                font-size:2.667vw;width: 20.8vw;
                line-height: 6.267vw;border-radius: 3.134vw;
                background: #FF4AA5 ;color:#fff;display:inline-block;text-align:center
            }
            `;
                ...
                <div class="rank_list">
                    <div class="rank_list_before">
                        <div class="p_rank">
                            ...
                            <div class="rank_focus_z" onclick="focusShopDom($(this),${rankData[1].isFavShop})">
                            <img class="rank_focus_small ${rankData[1].isFavShop === 1 ? 'hidden' : ''}" src="${imgSetting.small_focus}" onclick="focusShop('${rankData[1].actId}','${rankData[1].userId}','${rankData[1].sign}','${rankData[1].id}')"/>
                            <a class="goto_shop ${rankData[1].isFavShop === 1 ? '' : 'hidden'}" href="${rankData[1].shopUrl}">进店逛逛</a>
                            </div>
                        </div>
                        <div class="d_rank">
                            ...
                            <div class="rank_focus" onclick="focusShopDom($(this),${rankData[0].isFavShop})">
                            <img class="rank_focus_big ${rankData[0].isFavShop === 1 ? 'hidden' : ''}" src="${imgSetting.small_focus}" onclick="focusShop('${rankData[0].actId}','${rankData[0].userId}','${rankData[0].sign}','${rankData[0].id}')" />
                            <a class="goto_shop ${rankData[0].isFavShop === 1 ? '' : 'hidden'}" style="width: 22vw;height: 6.667vw;" href="${rankData[0].shopUrl}">进店逛逛</a>
                            </div>
                        </div>
                        <div class="g_rank">
                            ...
                            <div class="rank_focus_y" onclick="focusShopDom($(this),${rankData[2].isFavShop})">
                            <img class="rank_focus_small ${rankData[2].isFavShop === 1 ? 'hidden' : ''}" src="${imgSetting.small_focus}" onclick="focusShop('${rankData[2].actId}','${rankData[2].userId}','${rankData[2].sign}','${rankData[2].id}')"/>
                            <a class="goto_shop ${rankData[2].isFavShop === 1 ? '' : 'hidden'}" href="${rankData[2].shopUrl}">进店逛逛</a>
                            </div>
                        </div>
                    </div>
                    <div class="rank_list_after">
                        <div class="forth_rank">
                            ...
                            <div class="rank_focus" onclick="focusShopDom($(this),${rankData[3].isFavShop})">
                            <img class="rank_focus_small ${rankData[3].isFavShop === 1 ? 'hidden' : ''}" src="${imgSetting.small_focus}" onclick="focusShop('${rankData[3].actId}','${rankData[3].userId}','${rankData[3].sign}','${rankData[3].id}')"/>
                            <a class="goto_shop ${rankData[3].isFavShop === 1 ? '' : 'hidden'}" href="${rankData[3].shopUrl}">进店逛逛</a>
                            </div>
                        </div>
                        <div class="forth_rank">
                            ...
                            <div class="rank_focus" onclick="focusShopDom($(this),${rankData[4].isFavShop})">
                            <img class="rank_focus_small ${rankData[4].isFavShop === 1 ? 'hidden' : ''}" src="${imgSetting.small_focus}" onclick="focusShop('${rankData[4].actId}','${rankData[4].userId}','${rankData[4].sign}','${rankData[4].id}')"/>
                            <a class="goto_shop ${rankData[4].isFavShop === 1 ? '' : 'hidden'}" href="${rankData[4].shopUrl}">进店逛逛</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class='rank_container' id='rankContainerZr'>
            <div class="more_tasks">
                <img id="loadTaskYunZuanModal" 
                onclick='$("#taskYunZuanModal").removeClass("hidden");$("html,body").css("overflow","hidden");focusYuanZuan()' 
                class="more_tasks_img" src="${imgSetting.more_tasks}" />
            </div>
            <div class="show_rule">
                <img id="loadRuleModal" 
                onclick='$("#ruleModalZr").removeClass("hidden");$("html,body").css("overflow","hidden");'
                class="show_rule_img" src="${imgSetting.rule}" />
            </div>
            <div class="free_rank">
    ...
    function loadTaskModal(style, imgSetting) {
        ...
        <div class="modal">
            ...
            <div class="task_contanier">
                ...
                <div class="task_subtitle">已获得云钻：<span id="gettedYuanZuanNumZr"></span>个</div>
                <div class="task_item">
                    <div class="task_content">
                        <div class="task_content_left">
                            <img class="task_logo" src="${imgSetting.focus_logo}" alt="">
                            <div>
                                <div class="task_item_name">三免榜单 关注店铺领5个云钻</div>
                                <div class="task_item_description">每日最高可领15个云钻</div>
                            </div>
                        </div>
